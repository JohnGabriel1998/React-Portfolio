...
export const ScrollTimeline = ({
  ...
  const getCardVariants = (index: number) => {
    // Remove delays for immediate responsiveness
    const baseDelay = 0;
            ...
            <>
              ...
              <motion.div
                ...
                style={{
                  ...
                  background: `linear-gradient(to bottom, #8b5cf6, #6366f1, #a855f7)`,
              ...
              >
                <motion.div
                  className="w-4 h-4 rounded-full" // Slightly smaller for smoother look
                  style={{
                    background:
                      "radial-gradient(circle, rgba(168,85,247,0.9) 0%, rgba(99,102,241,0.6) 40%, rgba(139,92,246,0) 70%)",
                    // More subtle glow for smoother performance
                    boxShadow: `
              ...
              return (
                ...
                >
                  ...
                  >
                    <motion.div
                      className={cn(
                        "w-6 h-6 rounded-full border-4 bg-white dark:bg-gray-900 flex items-center justify-center",
                        index <= activeIndex
                          ? "border-violet-500"
                  ...
                  >
                    <Card className="bg-white dark:bg-gray-900 border hover:shadow-xl transition-shadow duration-300">
